1. How does CProxy_{base_class_name} know which child class to call. like is it not possible for a class in ci to have multiple childs that are inherting it ? 
